                            ...
                            <div class="max-w-md mx-auto w-full">
                                <div class="relative">
                                    ...
                                    <ul class="relative flex justify-between w-full">
                                        ...
                                        <li>
                                            <a class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400" href="/onboarding/02">2</a>
                                        </li>
                                        <li>
                                            <a class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400" href="/onboarding/03">3</a>
                                        </li>
                                        <li>
                        ...
                        <div class="max-w-md mx-auto">
                            ...
                            <form>
                                ...
                                <div class="flex items-center justify-between">
                                    <a class="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-auto" href="/onboarding/02">Next Step -&gt;</a>
                                </div>
                            </form>
