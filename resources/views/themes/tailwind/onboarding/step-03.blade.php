                        ...
                        <div class="max-w-md mx-auto">
                            ...
                            <form>
                                <div class="space-y-4 mb-8">
                                    <!-- Company Name -->
                                    <div>
                                        <label class="block text-sm font-medium mb-1" for="company-name">Your Full Name <span class="text-rose-500">*</span></label>
                                        <input id="company-name" class="form-input w-full" type="text" />
                                    </div>
                                    <!-- Email Address -->
                                    <div>
                                        <label class="block text-sm font-medium mb-1" for="email">Your Best Email <span class="text-rose-500">*</span></label>
                                        <input id="email" class="form-input w-full" type="text" />
                                    </div>
                                    <!-- Phone Number -->
                                    <div>
                                        <label class="block text-sm font-medium mb-1" for="phone">Your Phone/Cell Number <span class="text-rose-500">*</span></label>
                                        <input id="phone" class="form-input w-full" type="text" />
                                    </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <a class="text-sm underline hover:no-underline" href="{{ route('onboarding.step','02') }}">&lt;- Back</a>
                                    <a class="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-auto" href="{{ route('onboarding.step','04') }}">Next Step -&gt;</a>
                                </div>
                            </form>
